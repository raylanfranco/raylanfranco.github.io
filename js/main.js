(function ($) {
    ...
    function setPortfolio() {
        var grid = $('.grid').imagesLoaded(function () {
            grid.isotope({percentPosition: true, itemSelector: '.grid-item', masonry: {columnWidth: '.grid-sizer'}});
    ...
    function sendMail() {
        $('.contact-form [type="submit"]').on('click', function () {
            ...
            if (isValidEmailAddress(emailVal)) {
                ...
                $.ajax({
                    type: "POST", url: "php/sendMail.php", data: params, success: function (response) {
                        if (response) {
